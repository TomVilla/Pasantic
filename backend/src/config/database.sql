...
INSERT INTO `pasantic`.`pasantia` (`trabajo`, `idempresa`, `disponibilidad`, `fechapub`, `descripcion`, `requisitos`) VALUES ('informatico', '2', 32, '2022-01-10', 'hacer cosas', 'ninguno');
INSERT INTO `pasantic`.`pasantia` (`trabajo`, `idempresa`, `disponibilidad`, `fechapub`, `descripcion`, `requisitos`) VALUES ('mecanico', '3', 42, '2022-02-11', 'hacer cosas', 'ninguno');
INSERT INTO `pasantic`.`pasantia` (`trabajo`, `idempresa`, `disponibilidad`, `fechapub`, `descripcion`, `requisitos`) VALUES ('albañil', '4', 52, '2022-03-12', 'hacer cosas', 'ninguno');
INSERT INTO `pasantic`.`pasantia` (`trabajo`, `idempresa`, `disponibilidad`, `fechapub`, `descripcion`, `requisitos`) VALUES ('secretario', '5', 62, '2022-04-13', 'hacer cosas', 'ninguno');
INSERT INTO `pasantic`.`pasantia` (`trabajo`, `idempresa`, `disponibilidad`, `fechapub`, `descripcion`, `requisitos`) VALUES ('limpia casa', '6', 72, '2022-05-14', 'hacer cosas', 'ninguno');
